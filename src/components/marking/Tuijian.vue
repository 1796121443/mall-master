  ...
  <el-container>
    <el-main>
      <el-container class="container">
        ...
        <el-main class="main" >
          <el-form ref="form" :model="form" label-width="80px" inline="true">
            <el-form-item size="small" label="品牌名称:" label-width="150px">
              <el-input v-model="form.name" placeholder="品牌名称" style="width: 200px"></el-input>
            </el-form-item>
      ...
      <el-container>
        <el-main  class="row2">
          <el-row>
            ...
            <el-col :span="2">
              <el-button size="small" >选择品牌</el-button>
            </el-col>
          </el-row>
      ...
      <el-table
        ...
        border
        :data="tableData9.slice((currentPage-1)*pageSize,currentPage*pageSize)"
      >
...
<script>
  ...
  export default {
    ...
    computed:{
      tableData9:function(){
        return this.$store.state.tableData9;
      },
