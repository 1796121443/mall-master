      ...
      <el-container class="container">
        ...
        <el-main class="main" >
          <el-form ref="form" :model="form" label-width="80px" inline="true">
            <el-form-item size="small" label="优惠券名称:" label-width="150px">
              <el-input v-model="form.name" placeholder="优惠券名称" style="width: 200px"></el-input>
            </el-form-item>
            <el-form-item size="small" label="优惠券类型" label-width="200px">
