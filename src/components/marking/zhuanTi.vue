      ...
      <el-container class="container">
        ...
        <el-main class="main" >
          <el-form ref="form" :model="form" label-width="80px" inline="true">
            <el-form-item size="small" label="专题名称:" label-width="150px">
              <el-input v-model="form.name" placeholder="专题名称" style="width: 200px"></el-input>
            </el-form-item>
            <el-form-item  size="small" label="推荐状态" label-width="200px">
              <el-select v-model="form.value" placeholder="全部" clearable="true">
                <el-option label="推荐中" value="quan"></el-option>
                <el-option label="未推荐" value="hui"></el-option>
              </el-select>
            </el-form-item>
          </el-form>
        </el-main>
      ...
      <el-container>
        <el-main  class="row2">
          <el-row>
            ...
            <el-col :span="2">
              <el-button size="small" >选择专题</el-button>
            </el-col>
          </el-row>
